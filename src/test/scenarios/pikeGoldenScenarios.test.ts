...
describe('24 Hecht-Golden-Szenarien',()=>{
 ...
 it('wertet Barschbestand und unpassende Hechtgrößen nicht als verfügbar',()=>{expect(createRecommendationDecision(base,[{targetFish:'perch',lureTypeId:'jig',sizes:['large']},{targetFish:'pike',lureTypeId:'spinner',sizes:['small']}]).practicalPrimary).toBeUndefined()})
