...
export const setupRules: ScoringRule[] = [
  { id:'PL031',sourceRuleId:'R033',target:'setup',group:'thermalPhase',evidenceClass:'experience',confidence:.82,effect:2,reasonCode:'COLD_FINESSE',sourceIds:['S15','S16'],matches:x=>['cold','cool'].includes(x.conditions.waterTemperature)&&setup(x,'ned') },
  { id:'PL032',sourceRuleId:'R033',target:'setup',group:'thermalPhase',evidenceClass:'experience',confidence:.82,effect:2,reasonCode:'WINTER_FINESSE',sourceIds:['S15','S16'],matches:x=>x.conditions.waterTemperature==='unknown'&&x.conditions.season==='winter'&&setup(x,'ned') },
  ...
  { id:'PL035',sourceRuleId:'R036',target:'setup',group:'visibility',evidenceClass:'experience',confidence:.72,effect:1,reasonCode:'CLEAR_NATURAL',sourceIds:['S16'],matches:x=>x.conditions.turbidity==='clear'&&setup(x,'ned') },
  { id:'PL036',sourceRuleId:'R037',target:'setup',group:'visibility',evidenceClass:'experience',confidence:.7,effect:1,reasonCode:'DARK_CONTROL',sourceIds:['S10'],matches:x=>x.conditions.light==='dark'&&setup(x,'jig','ned') },
  ...
  { id:'OBS013',sourceRuleId:'R014',target:'setup',group:'presentation',evidenceClass:'observation',confidence:.95,effect:2,reasonCode:'DENSE_EDGE_FINESSE',sourceIds:['S06'],matches:x=>x.conditions.vegetation==='dense'&&x.spotId==='vegetation'&&setup(x,'ned') },
  ...
  { id:'FIT001',target:'setup',group:'presentation',evidenceClass:'experience',confidence:.8,effect:3,reasonCode:'DROPOFF_CONTROL',sourceIds:[],matches:x=>x.spotId==='dropoff'&&setup(x,'jig') },
  ...
  { id:'OBS015',sourceRuleId:'R038',target:'setup',group:'control',evidenceClass:'observation',confidence:.95,effect:2,reasonCode:'DEEP_CONTROL',sourceIds:['S15','S16'],matches:x=>x.conditions.depth==='deep'&&(setup(x,'jig')||((x.conditions.waterTemperature!=='cold'||x.conditions.activity.status==='observed')&&setup(x,'blade-bait','tail-spinner'))) },
