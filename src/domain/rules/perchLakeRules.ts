...
export const setupRules: ScoringRule[] = [
  ...
  { id:'PL033',sourceRuleId:'R024',target:'setup',group:'thermalPhase',evidenceClass:'science',confidence:.82,effect:-2,reasonCode:'HOT_SEARCH_PENALTY',sourceIds:['S24'],matches:x=>x.conditions.waterTemperature==='hot'&&setup(x,'twitchbait','spinner','crankbait','chatterbait','blade-bait','spinnerbait','popper') },
  { id:'PL034',sourceRuleId:'R011',target:'setup',group:'visibility',evidenceClass:'experience',confidence:.68,effect:2,reasonCode:'TURBID_SEARCH',sourceIds:['S16'],matches:x=>x.conditions.turbidity==='turbid'&&setup(x,'twitchbait','spinner','crankbait','chatterbait','spinnerbait') },
  ...
  { id:'OBS012',sourceRuleId:'R026',target:'setup',group:'activityObservation',evidenceClass:'observation',confidence:.95,effect:2,reasonCode:'BAITFISH_PROFILE',sourceIds:['S20'],matches:x=>sign(x.conditions,'baitfish')&&setup(x,'jig','twitchbait','spinner','crankbait','chatterbait','blade-bait','spinnerbait') },
  ...
  { id:'OBS016',sourceRuleId:'R014',target:'setup',group:'presentation',evidenceClass:'observation',confidence:.95,effect:-2,reasonCode:'DENSE_MOVING_BAIT_RISK',sourceIds:['S06'],matches:x=>x.conditions.vegetation==='dense'&&x.spotId==='vegetation'&&setup(x,'crankbait','chatterbait') },
  ...
  { id:'FIT002',target:'setup',group:'presentation',evidenceClass:'experience',confidence:.8,effect:3,reasonCode:'SHALLOW_SEARCH',sourceIds:[],matches:x=>x.spotId==='shallow'&&setup(x,'twitchbait','spinner','crankbait','chatterbait','spinnerbait') },
  ...
  { id:'PL043',sourceRuleId:'R004',target:'setup',group:'control',evidenceClass:'science',confidence:.88,effect:2,reasonCode:'AUTUMN_BLADE_DEPTH',sourceIds:['S01','S02','S11'],matches:x=>x.spotId==='dropoff'&&['autumn'].includes(x.conditions.season)&&setup(x,'blade-bait') },
  { id:'PL044',sourceRuleId:'R005',target:'setup',group:'control',evidenceClass:'experience',confidence:.75,effect:1,reasonCode:'COLD_BLADE_CONTROLLED',sourceIds:['S01','S02','S04','S18'],matches:x=>['cold','cool'].includes(x.conditions.waterTemperature)&&setup(x,'blade-bait') },
  ...
  { id:'PL050',sourceRuleId:'R033',target:'setup',group:'presentation',evidenceClass:'experience',confidence:.82,effect:-1,reasonCode:'COLD_BLADE_BEHIND_FINESSE',sourceIds:['S15','S16'],matches:x=>['cold'].includes(x.conditions.waterTemperature)&&x.conditions.activity.status!=='observed'&&setup(x,'blade-bait') },
]
